//link to the frront end (HTML, CSS)
...
if(grossPay <24001){
    payee=(grossPay*0.1);
    console.log(`Hello dear customer,  your tax is ksh ${payee}`);
}
...
//conditional statements to calculate NHIF deductions
// we use && to return true only if both  are true .
if (grossPay >= 0 && grossPay <= 5999) {
    NHIF=150;
    console.log(`Hello dear customer, your  NHIF is Ksh ${NHIF}`);
}
...
console.log(`Hello dear customer,your NSSF is ksh:${NSSF} `)
console.log("Hello dear customer,your net salary is ksh" ,netPay = grossPay - deductions, );
}